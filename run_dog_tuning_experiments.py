...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", type=Path, default=Path("results/dog_tuning_experiments0508"))
    parser.add_argument(
        "--geometry-categories",
        nargs="+",
    ...
    parser.add_argument("--color-scale", type=float, default=1.60)
    parser.add_argument("--substract-scale", type=float, default=1.00)
    parser.add_argument("--texture-scale", type=float, default=1.40)
    parser.add_argument("--texture2-scale", type=float, default=0.0)
    parser.add_argument("--geometry-scale", type=float, default=1.40)
    parser.add_argument("--geometry-sub-scale", type=float, default=0.80)
    parser.add_argument("--texture-color-decouple", type=float, default=0.10)
    parser.add_argument("--geometry-color-decouple", type=float, default=0.35)
    parser.add_argument("--color-to-geometry-decouple", type=float, default=0.25)
    ...
    parser.add_argument("--color-stage-factors", type=float, nargs=3, default=(1.0, 1.0, 1.0))
    parser.add_argument("--geometry-stage-factors", type=float, nargs=3, default=(1.0, 1.0, 0.0))
    parser.add_argument("--texture-stage-factors", type=float, nargs=3, default=(1.0, 1.0, 1.25))
    ...
    parser.add_argument("--punish-weight", type=float, default=0.0003)
...
def build_triples(args: argparse.Namespace) -> List[AssetTriple]:
    ...
    geometries = [p for p in list_images(geometry_dir) if resolve_geometry_category(p) in enabled_categories]
